    ...
    <body>
        ...
        <div class="container-fluid isi pt-5 pb-5 isi">
            <div class="container" >
                ...
                <div class="row pt-4 mb-3" data-aos="fade-left">
                    <div class="display-4 kata">
                        <h3 class="text-capitalize text-center fw-semibold"> beberapa kegiatan Saya</h3>
                    </div>
    
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mt-4 rounded-2 ">
                        <img src="{{asset('template\assets/images/kegiatan.jpeg')}}" class="img-fluid" alt="">
                    </div>
    
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mt-4 rounded-2 ">
                        <img src="{{asset('template\assets/images/kegiatan1.jpeg')}}" class="img-fluid" alt="">
                    </div>
    
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mt-4 rounded-2 ">
                        <img src="{{asset('template\assets/images/kegiatan2.jpeg')}}" class="img-fluid" alt="">
                    </div>
    
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mt-4 rounded-2 ">
                        <img src="{{asset('template\assets/images/kegiatan3.jpeg')}}" class="img-fluid" alt="">
                    </div>
                </div>
